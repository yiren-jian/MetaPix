...
from meta_domain_transfer.utils.serialization import yaml_load
...
cfg.TEST.OUTPUT_SIZE_TARGET = (1024, 512)
cfg.TEST.INFO_TARGET = str(project_root / 'meta_domain_transfer/dataset/cityscapes_list/info.json')
