...
from meta_domain_transfer.model.fcn8s_v2 import get_fcn8s_vgg
from meta_domain_transfer.dataset.cityscapes import CityscapesDataSet
from meta_domain_transfer.domain_adaptation.config import cfg, cfg_from_file
from meta_domain_transfer.domain_adaptation.eval_DA import evaluate_domain_adaptation
