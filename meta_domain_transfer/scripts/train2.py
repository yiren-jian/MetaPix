...
from meta_domain_transfer.domain_adaptation.train_DA2 import train_domain_adaptation
...
def main():
    ...
    source_dataset1 = GTA5DataSet(root=cfg.DATA_DIRECTORY_SOURCE,
                                 list_path=cfg.DATA_LIST_SOURCE,
                                 set=cfg.TRAIN.SET_SOURCE,
                                 max_iters=cfg.TRAIN.MAX_ITERS * cfg.TRAIN.BATCH_SIZE_SOURCE,
                                 crop_size=cfg.TRAIN.INPUT_SIZE_TARGET,
                                 mean=cfg.TRAIN.IMG_MEAN)
    source_dataset2 = SYNDataSet(root=cfg.DATA_DIRECTORY_SOURCE,
                                 list_path=cfg.DATA_LIST_SOURCE,
                                 set=cfg.TRAIN.SET_SOURCE,
                                 max_iters=cfg.TRAIN.MAX_ITERS * cfg.TRAIN.BATCH_SIZE_SOURCE,
                                 crop_size=cfg.TRAIN.INPUT_SIZE_TARGET,
                                 mean=cfg.TRAIN.IMG_MEAN)
    source_loader1 = data.DataLoader(source_dataset1,
                                    batch_size=cfg.TRAIN.BATCH_SIZE_SOURCE,
                                    num_workers=cfg.NUM_WORKERS,
                                    shuffle=True,
                                    pin_memory=True,
                                    worker_init_fn=_init_fn)
    source_loader2 = data.DataLoader(source_dataset2,
                                    batch_size=cfg.TRAIN.BATCH_SIZE_SOURCE,
                                    num_workers=cfg.NUM_WORKERS,
                                    shuffle=True,
                                    pin_memory=True,
    ...
    # UDA TRAINING
    train_domain_adaptation(model, source_loader1, source_loader2, target_loader, cfg)
